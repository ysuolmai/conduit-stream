...
static const char PAGE_HEAD[] =
    ...
    "color:#fff;font:600 16px system-ui}small{display:block;color:#697782;"
    "margin-top:7px}.name{font-weight:700;color:#182026}</style></head><body><main>";
...
static esp_err_t portal_get_handler(httpd_req_t *req) {
    ...
    if (send_text(req,
        ...
        "<button type=submit>Save and restart</button></form></main></body></html>") != ESP_OK) {
        return ESP_FAIL;
    }
